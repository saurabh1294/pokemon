...
sortApp.controller('sortCtrl', ['$scope', '$http',
	function($scope, $http) {
		// mock data 
		...
		$http({
			...
			console.log("POKEDATA", response.data.results, response);
		}, function myError(response) {
			$scope.pokedata = response.statusText;
			console.log(response);
		});
		
		$scope.pokedata = pokedata;
		console.log("Return ajax promise into pokedata ", $scope.pokedata, " is absent", pokedata);
		/*$scope.countries = [
		  {
			"CountryName": "Brazil",
		...
		$scope.searchPokemon   = '';     // set the default search/filter term
	}
]);
...
angular.bootstrap(document.getElementById("pokemonTable"), ['sortApp']);